...
/**
 * @brief       Write data buffer to VL53L0X device via i2c
 * @param dev   The device to write to
 * @param buff  The data buffer
 * @param len   The length of the transaction in byte
 * @return      0 on success
 */
int  I2CWrite(uint8_t address, uint8_t  *buff, uint8_t len);

/**
 *
 * @brief       Read data buffer from VL53L0X device via i2c
 * @param dev   The device to read from
 * @param buff  The data buffer to fill
 * @param len   The length of the transaction in byte
 * @return      0 on success
 */
int I2CRead(uint8_t address, uint8_t *buff, uint8_t len);
