...
/**
 * @brief Set the VCSEL power level.
 *
 * @par Function Description
 * This function sets the sensor power level
 *
 * @param   Dev                          Device Handle
 * @param   VCSEL_power                  power level valid range is 10-60
 * @return  "Other error code"           See ::VL53LX_Error
 */
VL53LX_Error VL53LX_SetVCSELPowerAdjust(VL53LX_DEV Dev, uint8_t VCSEL_power);

/**
 * @brief Get the VCSEL power level.
 *
 * @par Function Description
 * This function sets the sensor power level
 *
 * @param   Dev                          Device Handle
 * @param   VCSEL_power*                 pointer to power level
 * @return  "Other error code"           See ::VL53LX_Error
 */
